...
echo_and_run cd "/home/minuk/carla_ws/src/Mobile_System_Control/carla_ros_bridge/carla_spawn_objects"
...
echo_and_run /usr/bin/env \
    ...
    "/home/minuk/carla_ws/src/Mobile_System_Control/carla_ros_bridge/carla_spawn_objects/setup.py" \
     \
    build --build-base "/home/minuk/carla_ws/build/Mobile_System_Control/carla_ros_bridge/carla_spawn_objects" \
    install \
    --root="${DESTDIR-/}" \
