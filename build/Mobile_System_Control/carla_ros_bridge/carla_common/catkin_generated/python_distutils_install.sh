...
echo_and_run cd "/home/minuk/carla_ws/src/Mobile_System_Control/carla_ros_bridge/carla_common"
...
echo_and_run /usr/bin/env \
    ...
    "/home/minuk/carla_ws/src/Mobile_System_Control/carla_ros_bridge/carla_common/setup.py" \
     \
    build --build-base "/home/minuk/carla_ws/build/Mobile_System_Control/carla_ros_bridge/carla_common" \
    install \
    --root="${DESTDIR-/}" \
