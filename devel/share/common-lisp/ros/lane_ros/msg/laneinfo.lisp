...
(cl:defmethod cl:initialize-instance :after ((m <laneinfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'laneinfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lane_ros-msg:<laneinfo> is deprecated: use lane_ros-msg:laneinfo instead.")))

(cl:ensure-generic-function 'left_x-val :lambda-list '(m))
(cl:defmethod left_x-val ((m <laneinfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_ros-msg:left_x-val is deprecated.  Use lane_ros-msg:left_x instead.")
  (left_x m))

(cl:ensure-generic-function 'left_y-val :lambda-list '(m))
(cl:defmethod left_y-val ((m <laneinfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_ros-msg:left_y-val is deprecated.  Use lane_ros-msg:left_y instead.")
  (left_y m))

(cl:ensure-generic-function 'left_slope-val :lambda-list '(m))
(cl:defmethod left_slope-val ((m <laneinfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_ros-msg:left_slope-val is deprecated.  Use lane_ros-msg:left_slope instead.")
  (left_slope m))

(cl:ensure-generic-function 'right_x-val :lambda-list '(m))
(cl:defmethod right_x-val ((m <laneinfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_ros-msg:right_x-val is deprecated.  Use lane_ros-msg:right_x instead.")
  (right_x m))

(cl:ensure-generic-function 'right_y-val :lambda-list '(m))
(cl:defmethod right_y-val ((m <laneinfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_ros-msg:right_y-val is deprecated.  Use lane_ros-msg:right_y instead.")
  (right_y m))

(cl:ensure-generic-function 'right_slope-val :lambda-list '(m))
(cl:defmethod right_slope-val ((m <laneinfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lane_ros-msg:right_slope-val is deprecated.  Use lane_ros-msg:right_slope instead.")
  (right_slope m))
